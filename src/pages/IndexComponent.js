                ...
                <main>
                    <div className="relative pt-16 pb-32 flex content-center items-center justify-center"
                        ...
                        <div className="absolute top-0 w-full h-full bg-center bg-cover"
                            style={{
                                backgroundImage: "url('https://images.unsplash.com/photo-1586773860418-d37222d8fce3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1352&q=80')"
                            }}>
                                ...
                                <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                        <div className="px-4 py-5 flex-auto">
                                            ...
                                            <h6 className="text-xl font-semibold">ด้านการใช้งาน</h6>
                            ...
                            <div className="flex flex-wrap items-center mt-32">
                                <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                                    ...
                                    <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                                        Clinic Management เป็น web application service ที่พัฒนาโดยใช้ FlaskRestFul API และ React
                                    </p>
                                        ...
                                        <ul className="list-none mt-6">
                                            ...
                                            <li className="py-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <h4 className="text-gray-600">ระบบจัดการพนักงาน</h4>
                                                    </div>
                                                </div>
                                            </li>
                                            <li className="py-2">
                                            ...
                                            <li className="py-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <h4 className="text-gray-600">ระบบจัดการตารางคิว</h4>
                                                    </div>
                                                </div>
                                            </li>
                                            <li className="py-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <h4 className="text-gray-600">ระบบสร้างใบรายงานผลตรวจ</h4>
                                                    </div>
                                                </div>
                                            </li>
                                            <li className="py-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <h4 className="text-gray-600">ระบบประมวลผล Matchine Lerning As a service</h4>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="flex flex-wrap justify-center text-center mb-24">
                                <div className="w-full lg:w-6/12 px-4">
                                    ...
                                    <p className="text-lg leading-relaxed m-4 text-gray-600">
                                        สาขาวิทยาการคอมพิวเตอร์ คณะวิทยาศาสตร์ มหาวิทยาลัยศรีนครินทร์วิโรฒ
                                    </p>
                                </div>
                            </div>
                            <div className="flex flex-wrap">
                                <div className="w-full md:w-6/12 lg:w-4/12 lg:w-12/12 mb-12 px-4">
                                    <div className="px-6">
                                        <img
                                            alt="..."
                                            src={"https://www.pngkey.com/png/detail/140-1401137_leader-vector-cartoon-png-black-and-white-download.png"}
